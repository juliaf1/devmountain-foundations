...
/*
  ...
  If it is 80 degrees or above, one should wear a t-shirt.
  If it is between 60 and 80 degrees, and raining, one should wear a rain-jacket.
  If it is between 60 and 80 degrees, one should wear a t-shirt and carry a rain-jacket.
  If it is 60 degrees or below, and raining, one should wear a jacket and take an umbrella.
...
} else if (chillWeather) {
  if (rain) {
    message = 'Wear a rain-jacket'
  } else {
    message = 'Wear a t-shirt and carry a rain-jacket'
  };
} else {
