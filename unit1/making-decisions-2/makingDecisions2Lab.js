...
console.log(getLetterGrade(score));
...
let message = 'Not an eligible grade.';

switch (letterGrade) {
  case 'A':
    message = 'The student is doing excellently';
    break
  case 'B':
    message = 'The student is doing well';
    break
  case 'C':
    message = 'The student is doing alright';
    break
  case 'D':
    message = 'The student is not doing very well';
    break
  case 'F':
    message = 'The student is failing';
    break
  default:
    break
};
